...
export default function Index({ types }: Props) {
  ...
  const handleDelete = (id: number) => {
    deleteRequest(route('admin.event.destroy', id)); // event-specific route
  };
            ...
            {types.data.map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell className="text-right">
                  <Link href={route('admin.event.edit', item.id)}>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently delete <strong>{item.name}</strong>'s Event Type.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
